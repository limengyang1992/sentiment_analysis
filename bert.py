...
def train():
    ...
    dataset = load_dataset(
        "text",
        data_files={
            "train": r"dataset/sentiment/sentiment.train.data",
            "valid": r"dataset/sentiment/sentiment.valid.data",
            "test": r"dataset/sentiment/sentiment.test.data",
        },
    )
    ...
    model = AutoModelForSequenceClassification.from_pretrained(
        base_model, num_labels=2, cache_dir=pretrained_cache_dir
    )
